...
Pod::Spec.new do |s|
    ...
    s.subspec 'PLPlayer' do |plPlayer|
        plPlayer.source_files = 'ZFPlayer/Classes/PLPlayer/*.{h,m}'
        plPlayer.public_header_files = 'ZFPlayer/Classes/PLPlayer/*.h'
        plPlayer.dependency 'ZFPlayer/Core'
        #plPlayer.dependency 'PLPlayerKit'
    end
